        ...
        <header className={`header ${scrolled ? 'scrolled' : ''}`}>
          <div className="container header-inner">
            ...
            <nav className={`nav-links ${mobileMenuOpen ? 'mobile-active' : ''}`}>
              ...
              >
                <span style={{ cursor: 'pointer', color: '#f1f1f1', fontWeight: '500', display: 'flex', alignItems: 'center', gap: '6px' }}>Hizmetler <ChevronDown size={14} style={{ transform: activeMobileDropdown === 'hizmetler' ? 'rotate(180deg)' : 'none', transition: '0.3s' }} /></span>
              ...
              >
                <span style={{ cursor: 'pointer', color: '#f1f1f1', fontWeight: '500', display: 'flex', alignItems: 'center', gap: '6px' }}>Kurumsal <ChevronDown size={14} style={{ transform: activeMobileDropdown === 'kurumsal' ? 'rotate(180deg)' : 'none', transition: '0.3s' }} /></span>
