        ...
        <header className={`header ${scrolled ? 'scrolled' : ''}`}>
          <div className="container header-inner">
            <Link to="/" className="brand-logo" onClick={() => setMobileMenuOpen(false)}>
              <img src="/logo.png" alt="Socialart Ajans" style={{ height: '50px', width: 'auto' }} />
            </Link>
            ...
            <div className="footer-inner" style={{ borderBottom: '1px solid var(--surface-border)', paddingBottom: '40px' }}>
              <div className="footer-col">
                ...
                <div className="social-links">
                  <a href="https://instagram.com/socialartmedya" target="_blank" rel="noreferrer" className="instagram"><Instagram size={20} /></a>
                  <a href="https://linkedin.com/company/socialartmedya" target="_blank" rel="noreferrer" className="linkedin"><Linkedin size={20} /></a>
                  <a href="https://youtube.com/@socialartmedya" target="_blank" rel="noreferrer" className="youtube"><Youtube size={20} /></a>
