            ...
            <nav className={`nav-links ${mobileMenuOpen ? 'mobile-active' : ''}`}>
              ...
              >
                ...
                <div className="dropdown-container">
                  ...
                  <Link to="/musteri" style={{ display: 'flex', alignItems: 'center', padding: '12px 16px', color: '#f1f1f1', cursor: 'pointer', fontSize: '0.95rem', borderRadius: '8px', transition: 'all 0.2s', fontWeight: '500', marginTop: '4px' }} onMouseEnter={(e) => {e.currentTarget.style.color = '#fff'; e.currentTarget.style.background = 'rgba(255,255,255,0.05)'}} onMouseLeave={(e) => {e.currentTarget.style.color = '#f1f1f1'; e.currentTarget.style.background = 'transparent'}} onClick={() => { setMobileMenuOpen(false); setActiveMobileDropdown(null); }}><Users size={18} style={{marginRight: '12px', color: '#00e5ff'}} /> Müşteri Girişi</Link>
                </div>
              </div>
            </nav>
