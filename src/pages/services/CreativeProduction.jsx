        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
            <div className="glass" style={{ padding: '40px', borderRadius: '32px', border: '1px solid rgba(255,255,255,0.05)', position: 'relative', overflow: 'hidden' }}>
               <img src="https://zpulnweiosxphibipxdp.supabase.co/storage/v1/object/public/site-assets/images/studio-preview.jpg" alt="Stüdyo" style={{ width: '100%', borderRadius: '20px', marginBottom: '20px' }} />
